...
class View {
    ...
    // Méthode render_grid() personnalisée pour n'afficher que les avis sous forme de cartes
    private function render_grid($businesses, $reviews, $options, $is_admin = false)
    {
        // On ignore $businesses pour ne pas afficher les infos du lieu
        echo '
        <section class="avis-section py-5 text-white" 
                 style="background: linear-gradient(to right, #f89b29, #ff0f7b); direction: rtl;">
          <div class="container text-center">
            <h2 class="fw-bold mb-4">"خطوة" منصتك الشاملة لتحقيق حلمك بالدراسة في الخارج!</h2>
        ...
        if (!empty($reviews)) {
            foreach ($reviews as $review) {
                ...
                $author = isset($review->author_name) ? $review->author_name : 'Utilisateur Google';
                $avatar = !empty($review->author_avatar)
                          ? $review->author_avatar
                          : 'https://via.placeholder.com/40';
                $time   = isset($review->relative_time_description)
                ...
                <div class="col-md-3 mb-4">
                  <div class="card h-100 shadow-sm rounded-4 text-end p-3">
                    <div class="mb-2">
                      <img src="https://www.gstatic.com/images/branding/product/2x/google_96dp.png" 
                           alt="Google" width="25" />
                      ' . $stars . '
                    </div>
                    <p class="small">' . esc_html($text) . '</p>
                    <div class="d-flex align-items-center justify-content-end mt-3">
                      <div class="me-2">
                        <strong>' . esc_html($author) . '</strong><br>
                        <span class="text-muted">' . esc_html($time) . '</span>
                      </div>
        ...
        echo '
            ...
            <a href="#contact" class="btn btn-danger mt-4 rounded-pill px-4 py-2 fw-bold">
